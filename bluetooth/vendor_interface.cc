...
#define LOG_TAG "android.hardware.bluetooth@1.0-impl-aw"
...
bool VendorInterface::Open(InitializeCompleteCallback initialize_complete_cb,
  ...
  VENDOR_LIBRARY_NAME = get_bluetooth_libbt_name();
  ALOGD("%s, get libbt name: %s.", __func__, VENDOR_LIBRARY_NAME);
